...
bot.on("message", async message => {
	...
	.addField(`${args[0].toUpperCase() || `\u200b`}`, `*${args[1] || `\u200b`}*`, true)
	.addField(`${args[2].toUpperCase() || `\u200b`}`, `*${args[3] || `\u200b`}*`, true)
	.addField(`${args[4].toUpperCase() || `\u200b`}`, `*${args[5] || `\u200b`}*`, true)
	.addField(`${args[6].toUpperCase() || `\u200b`}`, `*${args[7] || `\u200b`}*`, true)
	.addField(`${args[8].toUpperCase() || `\u200b`}`, `*${args[9] || `\u200b`}*`, true)
	.addField(`${args[10].toUpperCase() || `\u200b`}`, `*${args[11] || `\u200b`}*`, true)
	.addField(`${args[12].toUpperCase() || `\u200b`}`, `*${args[13] || `\u200b`}*`, true)
	.addField(`${args[14].toUpperCase() || `\u200b`}`, `*${args[15] || `\u200b`}*`, true)
